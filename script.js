...
const library = [
  ...
  { category: "common", symbol: "♡", label: "空心爱心", code: "aixin", keywords: ["heart", "outline", "收藏"] },
  { category: "common", symbol: "•", label: "圆点", code: "dian", keywords: ["bullet", "dot", "列表"] },
  { category: "common", symbol: "·", label: "间隔点", code: "dian", keywords: ["middle dot", "separator", "间隔"] },
  ...
  { category: "common", symbol: "°", label: "度数符", code: "du", keywords: ["degree", "temperature", "角度"] },
  { category: "units", symbol: "°C", label: "摄氏度", code: "du", keywords: ["celsius", "temperature", "摄氏"] },
  { category: "units", symbol: "°F", label: "华氏度", code: "du", keywords: ["fahrenheit", "temperature", "华氏"] },
  ...
  { category: "math", symbol: "√", label: "根号", code: "genhao", keywords: ["sqrt", "root", "开方"] },
  ...
  { category: "math", symbol: "∝", label: "成正比", code: ["chengzhengbi", "zhengbi"], keywords: ["proportional", "ratio", "比例"] },
  ...
  { category: "logic", symbol: "∧", label: "逻辑与", code: ["yu", "and"], keywords: ["logical and", "logic", "且"] },
  { category: "logic", symbol: "∨", label: "逻辑或", code: ["huo", "or"], keywords: ["logical or", "logic", "或"] },
  { category: "logic", symbol: "¬", label: "逻辑非", code: ["fei", "not"], keywords: ["logical not", "logic", "非"] },
  ...
  { category: "greekUpper", symbol: "Α", label: "Alpha", code: "Alpha", keywords: ["greek", "alpha", "uppercase"] },
  { category: "greekUpper", symbol: "Β", label: "Beta", code: "Beta", keywords: ["greek", "beta", "uppercase"] },
  { category: "greekUpper", symbol: "Γ", label: "Gamma", code: "Gamma", keywords: ["greek", "gamma", "uppercase"] },
  { category: "greekUpper", symbol: "Δ", label: "Delta", code: "Delta", keywords: ["greek", "delta", "uppercase"] },
  { category: "greekUpper", symbol: "Ε", label: "Epsilon", code: "Epsilon", keywords: ["greek", "epsilon", "uppercase"] },
  { category: "greekUpper", symbol: "Ζ", label: "Zeta", code: "Zeta", keywords: ["greek", "zeta", "uppercase"] },
  { category: "greekUpper", symbol: "Η", label: "Eta", code: "Eta", keywords: ["greek", "eta", "uppercase"] },
  { category: "greekUpper", symbol: "Θ", label: "Theta", code: "Theta", keywords: ["greek", "theta", "uppercase"] },
  { category: "greekUpper", symbol: "Ι", label: "Iota", code: "Iota", keywords: ["greek", "iota", "uppercase"] },
  { category: "greekUpper", symbol: "Κ", label: "Kappa", code: "Kappa", keywords: ["greek", "kappa", "uppercase"] },
  { category: "greekUpper", symbol: "Λ", label: "Lambda", code: "Lambda", keywords: ["greek", "lambda", "uppercase"] },
  { category: "greekUpper", symbol: "Μ", label: "Mu", code: "Mu", keywords: ["greek", "mu", "uppercase"] },
  { category: "greekUpper", symbol: "Ν", label: "Nu", code: "Nu", keywords: ["greek", "nu", "uppercase"] },
  { category: "greekUpper", symbol: "Ξ", label: "Xi", code: "Xi", keywords: ["greek", "xi", "uppercase"] },
  { category: "greekUpper", symbol: "Ο", label: "Omicron", code: "Omicron", keywords: ["greek", "omicron", "uppercase"] },
  { category: "greekUpper", symbol: "Π", label: "Pi", code: "Pi", keywords: ["greek", "pi", "uppercase"] },
  { category: "greekUpper", symbol: "Ρ", label: "Rho", code: "Rho", keywords: ["greek", "rho", "uppercase"] },
  { category: "greekUpper", symbol: "Σ", label: "Sigma", code: "Sigma", keywords: ["greek", "sigma", "uppercase"] },
  { category: "greekUpper", symbol: "Τ", label: "Tau", code: "Tau", keywords: ["greek", "tau", "uppercase"] },
  { category: "greekUpper", symbol: "Υ", label: "Upsilon", code: "Upsilon", keywords: ["greek", "upsilon", "uppercase"] },
  { category: "greekUpper", symbol: "Φ", label: "Phi", code: "Phi", keywords: ["greek", "phi", "uppercase"] },
  { category: "greekUpper", symbol: "Χ", label: "Chi", code: "Chi", keywords: ["greek", "chi", "uppercase"] },
  { category: "greekUpper", symbol: "Ψ", label: "Psi", code: "Psi", keywords: ["greek", "psi", "uppercase"] },
  { category: "greekUpper", symbol: "Ω", label: "Omega", code: "Omega", keywords: ["greek", "omega", "uppercase"] }
].map((item, index) => {
  const codes = [...new Set((Array.isArray(item.code) ? item.code : [item.code])
  ...
  return {
    ...
    keywordsText: [item.symbol, item.label, ...codes, ...(item.keywords || [])].join(" ").toLowerCase()
  };
});
...
function renderGrid() {
  ...
  gridElement.innerHTML = visibleItems
    .map((item) => {
      const shortcuts = composeShortcuts(item);
      ...
      return `
        <div class="symbol-card ${selected ? "selected" : ""}" data-id="${item.id}" tabindex="0" role="button" aria-pressed="${selected}">
          ...
          <div class="symbol-meta">
            <span class="shortcut">${escapeHtml(shortcuts.join(" / "))}</span>
          </div>
        </div>
      `;
    })
...
function composeShortcuts(item) {
  return item.code.map((code) => `${state.prefix}${String(code).toLowerCase()}`);
}

function buildPlist(items) {
  const rows = items
    .flatMap((item) => {
      return composeShortcuts(item).map((shortcut) => `\t<dict>
\t\t<key>phrase</key>
\t\t<string>${escapeXml(item.symbol)}</string>
\t\t<key>shortcut</key>
\t\t<string>${escapeXml(shortcut)}</string>
\t</dict>`);
    })
    .join("\n");
